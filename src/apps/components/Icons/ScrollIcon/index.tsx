...
export default class ScrollIcon extends Component<Props, State> {
  render() {
    ...
    return <svg className={className.value} width="78" height="88" viewBox="0 0 78 88" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path class={className.elt('arrow').mod('first').value} d="M44.1672 51.9348L33.4092 56.464L28.2368 46" stroke={strokeColor} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path class={className.elt('arrow').mod('second').value} d="M40.7234 59.4944L29.9653 64.0236L24.793 53.5595" stroke={strokeColor} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  }
}
