...
class Snippet2 extends Component<Props, {}> {
  static clss: string = 'syrie-snippet-2'
  clss = Snippet2.clss
  ...
  render (): JSX.Element {
    ...
    const pagesData = allPagesData.filter(page => page.target_article_id === 'snippet-2')
...
export type { Props, Snippet2 }
export default appWrapper(Snippet2)
